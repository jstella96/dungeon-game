...
function backgroundDesign(){
	 //ctx.drawImage(design2Img,128,95,32,32,290,280,40,40)
}
...
treasureImg.src = '<c:url value="/resources/img/map/boxkey/box2.png"/>';

var treasureOpenImg =new Image;
treasureOpenImg.src = '<c:url value="/resources/img/map/boxkey/box2open.png"/>';


var treasurePositionArr =[11*standardLength+15,6*standardLength-60,60,60];//drawTreasure(treasureImg,[90*3,100,60,60]);
...
function keyDownNoticHandler(e){
	...
	if(e.keyCode == 32) {
		 if( myCharacterX > treasurePositionArr[0]-50 &&  myCharacterX < treasurePositionArr[0]+treasurePositionArr[2]+50 &&
		    ...
		    treasureEventExistence==true && getItems.includes("key2"))
		 {
