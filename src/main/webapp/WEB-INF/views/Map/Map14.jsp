...
treasureImg.src = '<c:url value="/resources/img/map/boxkey/box3.png"/>';

var treasureOpenImg =new Image;
treasureOpenImg.src = '<c:url value="/resources/img/map/boxkey/box3open.png"/>';


var treasurePositionArr =[5*standardLength+15,8*standardLength-60,60,60];//drawTreasure(treasureImg,[90*3,100,60,60]);
...
function keyDownNoticHandler(e){
	...
	if(e.keyCode == 32) {
		 if( myCharacterX > treasurePositionArr[0]-50 &&  myCharacterX < treasurePositionArr[0]+treasurePositionArr[2]+50 &&
		    ...
		    treasureEventExistence==true && getItems.includes("key3"))
		 {
